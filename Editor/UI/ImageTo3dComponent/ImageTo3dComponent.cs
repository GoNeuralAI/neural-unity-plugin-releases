...
namespace Neural
{
    public class ImageTo3dComponent : Component
    {
        ...
        protected override void InitializeUI()
        {
            ...
            FileSelector.RegisterCallback<ChangeEvent<string>>(evt =>
            {
                CheckGenerateBtnState();
            });
            ...
            var jobs = Context.JobController.GetJobsByType(JobType.ImageTo3D);
        ...
        protected void OnGenerateBtnClicked(ClickEvent evt)
        {
            ...
            var job = new ImageTo3dJob(PromptField.Text, FileSelector.FilePath, negativePrompt, seed, faceLimit, HasPbr.value);
            job.Execute();
            ConfigureJob(job);
